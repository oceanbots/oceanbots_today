...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'oceanbots' ); ?></h1>
	</header><!-- .page-header -->
	...
	<div class="page-content">
		...
		if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
			...
			<p><?php printf( wp_kses( __( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'oceanbots' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( admin_url( 'post-new.php' ) ) ); ?></p>
